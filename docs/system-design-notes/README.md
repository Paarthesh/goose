> **Attribution:** These notes are copied from [liquidslr/system-design-notes](https://github.com/liquidslr/system-design-notes) by [Joshua Emmanuel](https://github.com/liquidslr), and are not affiliated with or maintained by the goose project. They are unrelated to goose's own codebase and are kept here for reference only. The source repository ships no explicit license, so treat this content as "all rights reserved" by its author pending explicit permission — do not redistribute it further without checking with the original author.
 ...
 * [Chapter 27 - Digital Wallet](./27.%20Digital%20Wallet/)
