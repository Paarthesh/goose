...
---
Source: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill (MIT License, see LICENSE in this folder). Vendored data/scripts only — the project's separate CLI and gallery app were not included.
